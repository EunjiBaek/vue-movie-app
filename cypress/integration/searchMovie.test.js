// 1. 검색(메인) 페이지로 접근한 후,
// 2. 영화 제목을 'frozen'으로, 표시 개수를 30개로 입려가혹,
// 3. 'Apply' 버튼을 클릭해 영화 목록을 검색합니다.
// 4. 영화 목록 30개가 잘 출력됩니다.
// 5. 영화 목록에서 'Frozen II (겨울왕국2)' 영화 아이템을 클릭하면,
// 6. 영화 상세 정보 페이지로 이동합니다.
// 7. 상세 정보 페이지에서 정보를 확인할 수 있습니다.
